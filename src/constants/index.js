...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: `As Human Resource Director at IEEE WIE MUJ, I manage HR activities, oversee recruitment, foster member engagement, and support organizational goals.`,
...
export const PROJECTS = [
  {
    ...
    image: project1,
    description: `Developed an AI-based Flappy Bird game using Pygame and the NEAT algorithm for automated gameplay. Utilized Python for implementation.`,
    technologies: ["Python", "NEAT", "NumPy", "Pandas", "Scikit-learn", "Tkinter", "OpenCV"],
  },
  {
    title: "Sudoku Solver",
    image: project21,
    description: `This C code solves a Sudoku puzzle using backtracking, validating numbers placed in cells and finding a valid solution.`,
    technologies: ["C Language", "Backtracking", "I/O Libraries"],
  },
  {
    title: "Gesture Sphere Challenge",
    image: project3,
    description: `Python script uses MediaPipe and OpenCV for a hand-tracking game where players catch moving balls with gestures, scoring points.`,
    technologies: ["Python", "MediaPipe", "OpenCV", "NumPy"],
  },
  {
    title: "Portfolio Website",
    image: project4,
    description: `ReactJS portfolio with Tailwind CSS styling and Framer Motion animations for a sleek, interactive user experience.`,
